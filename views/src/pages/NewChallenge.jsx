...
const NewChallenge = () => {
  ...
  <>
    ...
    <div>
      ...
      <input type="text" name="name" value={state.name} onChange={(event) => handleUserInput(event)} />
      {error.name !== "" ?? <span>{error.name}</span>}
    </div>
    <div>
      <label htmlFor="desc">Description</label>
      <input type="text" name="desc" value={state.description} placeholder="A quick summary of your challenge" />
    </div>
